...
const MAP = [
  ...
  [/^src\/control\//, ['control.spec.ts', 'exports.spec.ts', 'shows.spec.ts']],
  ...
  [/^src\/components\/(fields|SampleDataPanel|ControlPanel)/, ['control.spec.ts', 'shows.spec.ts', 'images.spec.ts', 'ux.spec.ts', 'video-inputs.spec.ts', 'import-graphic.spec.ts']],
