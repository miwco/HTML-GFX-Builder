...
// .l3-box::before with transform: skewX(-8deg); presets tween .l3-box itself (snap-stinger
...
// unskewed .l3-box and reads dead straight. The accent is a chunky vertical slab inside the
...
/* The painted slab: the sport lean lives HERE, on a background layer no preset ever tweens.
   snap-stinger animates .l3-box skewX -10 -> 0; keeping the design lean on this pseudo-layer
