...
// (templates/shared/standard.ts) to the lower-third contract: class prefix "l3",
...
export function lineMasks(o: ResolvedOptions, indent = '      '): string {
  return lineMasksFor('l3', o, indent);
}
