...
src/
  ...
  templates/ * the wizard catalog: shared assemblers + 17 categories (11 core + frames = chrome
               around a camera HOLE + transitions = a full-frame cover that clears itself on a
               timer + the COMPETITION PACK's four - docs/COMPETITION_PACK.md); :root style
               contract;
